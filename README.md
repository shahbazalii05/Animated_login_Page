...
This project is an **Animated Login Page** built with HTML, CSS, JavaScript, and GSAP (GreenSock Animation Platform). The page offers a smooth, visually appealing experience with dynamic animations for form fields, buttons, and background effects.

## Features

- **Smooth Animations:** GSAP-powered animations for a seamless user experience.
- **Interactive Elements:** Hover effects, button animations, and form transitions.
- **Fully Responsive:** Adapts to various screen sizes (mobile, tablet, desktop).
- **Simple and Elegant Design:** Focuses on user-friendly navigation and clean layout.
...
## Desktop view
[Login Page.webm](https://github.com/user-attachments/assets/37450592-3e60-41b2-beb4-500ec347ae40)
...
- git clone https://github.com/shahbazalii05/Animated_login_Page.git
- cd Animated_login_Page
